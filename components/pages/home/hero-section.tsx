    ...
    <section>
      <div className="text-center sm:mx-auto lg:mr-auto space-y-1.5">
        <h1 className="text-6xl md:text-7xl xl:text-[5.25rem] font-bold">
          <span className="font-bold text-transparent bg-clip-text bg-gradient-to-br  from-rose-50  to-rose-600">
            Index Git for Cursor
          </span>
        </h1>

        <p className="mx-auto max-w-2xl text-base sm:text-lg text-zinc-200">
